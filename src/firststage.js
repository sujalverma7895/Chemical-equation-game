...
import img2 from './third-reactants.png';
   ...
   const submit=()=>{
    ...
    <div className='main'>
      ...
      <div className='right-side-button'>
        ...
        <p className='right-first-p'>
          On the left is a balance chemical equation and the available reactants for a reaction.
        ...
        <button className={next}><Link className="link" to="/Secondstage">Next</Link></button>
